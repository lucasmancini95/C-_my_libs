...
typedef
typedef enum estado {aterrizando, despegando} estado_vuelo;
...
class Avion{
    ...
    public:
      Avion(){}
      Avion(int nv,int hll, estado_vuelo e){
        numero_vuelo=nv;
        hora_llegada=hll;
        estado=e;
      }
      void despegar(){
        cout<< "el vuelo numero " << numero_vuelo << "esta despegando" <<endl;
      }
      void aterrizar(){
        cout<< "el vuelo numero " << numero_vuelo << "esta aterrizando " << endl;
      }
      void cancelar_aterrizage(){
        cout<< "el vuelo numero " << numero_vuelo << "no pudo aterrizar" << endl;
      }
      void cancelar_despegue(){
        cout<< "el vuelo numero " << numero_vuelo << "no pudo despegar" << endl;
      }

};

class Pista_aeropuerto{
  private:
    queue fila_aterrizar;
    queue fila despegar;
    queue largo_maximo;
  public:
    bool aterrizar;
