...
/*Lecturas para skip list:

Para caracterización:

Capitulo del libro de Drozdek (edición nueva). Acá va el enlace por Google Books:

https://books.google.com.ar/books?id=PRgLAAAAQBAJ&pg=PA97&lpg=PA97&dq=skip+list+drozdek&source=bl&ots=zZKgFZl-qH&sig=jJRH7_laQmMdROCU4k87vlv_lDA&hl=es-419&sa=X&ved=0ahUKEwj06unH7NTMAhVOlpAKHUkfDGUQ6AEIMjAD#v=onepage&q=skip%20list%20drozdek&f=false



Y les dejo un enlace un paper muy interesante que las relaciona con otras estructuras que vimos (para leer un poco más adelante):

http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.399.6035&rep=rep1&type=pdf
*/
